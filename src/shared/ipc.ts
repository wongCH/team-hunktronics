...
export const IPC = {
  ...
  llmWikiStatus: 'llmWiki:status',
  llmWikiReferenceFound: 'llmWiki:referenceFound',
  llmWikiChoose: 'llmWiki:choose',
  llmWikiCreate: 'llmWiki:create',
  llmWikiRemove: 'llmWiki:remove',
